  ...
  static arrangeInvalidRequest() {
    ...
    return {
      ...
      DESCRIPTION_NOT_A_STRING: {
        ...
        expected: {
          message: ['name should not be empty', 'name must be a string', 'description must be a string'],
          ...defaultExpected
        }
      },
      IS_NOT_ACTIVE_A_BOOLEAN: {
        send_data: {
          description: 5
        },
        expected: {
          message: ['name should not be empty', 'name must be a string', 'is_active must be a boolean'],
          ...defaultExpected
        }
      },
    }
